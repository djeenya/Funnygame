...
export default function GamePage() {
  ...
  const renderPidstavaRound = (round: Round) => {
    ...
    if (isAllCardsPlayed) {
      return (
        <div className="flex flex-col items-center justify-center gap-6 py-8 animate-fadeIn w-full text-center">
          <div className="w-16 h-16 rounded-2xl bg-amber-500 flex items-center justify-center text-slate-950 shadow-xl shadow-amber-500/20 mb-2">
            <Trophy size={32} />
          </div>
          <div>
            ...
            <h2 className="text-3xl font-black text-white mt-3">Усі 8 тем «Підстави» зіграно</h2>
            <p className="text-zinc-400 text-xs mt-1">Ознайомтесь із результатами та перейдіть до Раунду 2: «Коментарі»</p>
          </div>
          <button
            onClick={nextRound}
            className="px-6 py-3 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-extrabold text-xs transition cursor-pointer shadow-lg shadow-amber-500/20 flex items-center gap-1.5 uppercase tracking-wider"
          >
    ...
    if (easyHardActiveCardIdx === null) {
      return (
        <div className="flex flex-col gap-6 w-full animate-fadeIn">
          {/* Header Turn Banner */}
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-zinc-950 p-4 rounded-2xl border border-zinc-800/80 shadow-lg">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-zinc-400 font-mono bg-zinc-900 px-2.5 py-0.5 rounded-md border border-zinc-800">
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between w-full">
                    ...
                    {isPlayed && (
                      <span className="text-[10px] font-black text-zinc-500 bg-zinc-900 px-2 py-0.5 rounded-md border border-zinc-800 uppercase">
                        ✓ Зіграно
                      </span>
                    )}
                  </div>
                  ...
                  <div className="mt-2">
                    ...
                    <h4
                      className={`text-sm sm:text-base font-black leading-tight mt-0.5 line-clamp-3 uppercase tracking-tight ${isPlayed ? "text-zinc-600" : "text-slate-950 drop-shadow-sm"
                        }`}
                    >
                      {card.topic}
                    </h4>
    ...
    if (easyHardDifficulty === null) {
      return (
        <div className="flex flex-col items-center justify-center gap-6 py-6 w-full animate-fadeIn max-w-xl mx-auto text-center">
          <div className="flex items-center justify-between w-full pb-3 border-b border-zinc-800/80">
            ...
            >
              <ChevronLeft size={14} /> Назад до сітки тем
            </button>
          ...
          <div className="bg-gradient-to-br from-amber-400 via-amber-500 to-orange-500 text-slate-950 p-6 rounded-3xl border-2 border-amber-300 w-full shadow-2xl">
            <span className="text-[10px] font-black text-amber-950/80 uppercase tracking-widest block">
              Обрана тема підстави
            </span>
            <h3 className="text-2xl sm:text-3xl font-black mt-1 uppercase tracking-tight">
              {activeCard.topic}
            </h3>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
            <button
              ...
              className="p-6 rounded-3xl bg-emerald-950/30 hover:bg-emerald-900/40 border-2 border-emerald-500/40 hover:border-emerald-400 text-white transition flex flex-col items-center gap-2 cursor-pointer shadow-xl shadow-emerald-950/30 group hover:scale-[1.02]"
            >
              <span className="px-3 py-1 rounded-full bg-emerald-500/20 text-emerald-400 text-[10px] font-black uppercase tracking-wider">
                Рівень 1
              </span>
              <span className="text-xl font-black group-hover:text-emerald-400 uppercase tracking-tight">
                Легке запитання
              </span>
            ...
            <button
              ...
              className="p-6 rounded-3xl bg-rose-950/30 hover:bg-rose-900/40 border-2 border-rose-500/40 hover:border-rose-400 text-white transition flex flex-col items-center gap-2 cursor-pointer shadow-xl shadow-rose-950/30 group hover:scale-[1.02]"
            >
              <span className="px-3 py-1 rounded-full bg-rose-500/20 text-rose-400 text-[10px] font-black uppercase tracking-wider">
                Рівень 2
              </span>
              <span className="text-xl font-black group-hover:text-rose-400 uppercase tracking-tight">
                Складне запитання
              </span>
    ...
    return (
      <div className="flex flex-col gap-6 w-full animate-fadeIn max-w-3xl mx-auto">
        {/* Top Info Bar */}
        ...
        <div className="bg-white text-slate-950 p-6 sm:p-10 rounded-3xl shadow-2xl border-4 border-amber-400 text-center relative overflow-hidden">
          <span className="text-[10px] font-black tracking-widest text-amber-600 uppercase block mb-2">
            Шоу ВКВ • Запитання
          </span>
          <h3 className="text-xl sm:text-2xl md:text-3xl font-black leading-snug uppercase tracking-tight">
            {questionText}
          </h3>
        </div>

        {/* Host Guidance: Correct Answer Box */}
        <div className="p-4 sm:p-5 bg-emerald-950/20 border-2 border-emerald-500/40 rounded-2xl flex flex-col gap-1 shadow-lg">
        ...
        {currentFact && (
          <div className="p-4 bg-blue-950/20 border border-blue-500/30 rounded-2xl flex items-start gap-3 shadow-md animate-fadeIn">
        ...
        {easyHardJudgmentGiven === null ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full mt-2">
            <button
              ...
              className="py-4 bg-emerald-600 hover:bg-emerald-500 active:scale-[0.98] text-white rounded-2xl font-black text-sm sm:text-base transition cursor-pointer shadow-xl shadow-emerald-600/20 flex items-center justify-center gap-2 uppercase tracking-wider"
            >
            ...
            <button
              ...
              className="py-4 bg-rose-600 hover:bg-rose-500 active:scale-[0.98] text-white rounded-2xl font-black text-sm sm:text-base transition cursor-pointer shadow-xl shadow-rose-600/20 flex items-center justify-center gap-2 uppercase tracking-wider"
            >
              <XCircle size={20} />
          ...
          <div className="flex flex-col items-center gap-3 w-full animate-fadeIn mt-2">
            ...
            <button
              ...
              className="w-full py-4 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-slate-950 rounded-2xl font-black text-sm uppercase tracking-wider transition cursor-pointer shadow-xl shadow-amber-500/20 flex items-center justify-center gap-2"
            >
              <span>Завершити хід та передати вибір іншій команді</span>
  ...
  const renderCommentsRound = (round: Round) => {
    ...
    if (isRoundFinished) {
      return (
        <div className="flex flex-col items-center justify-center gap-6 py-8 animate-fadeIn w-full text-center">
          <div className="w-16 h-16 rounded-2xl bg-rose-600 flex items-center justify-center text-white shadow-xl shadow-rose-600/20 mb-2">
            <Trophy size={32} />
          </div>
          <div>
            ...
            <h2 className="text-3xl font-black text-white mt-3">Усі 4 гри «Коментарів» зіграно</h2>
            <p className="text-xs text-zinc-400 mt-1">Ознайомтесь із результатами та перейдіть до Раунду 3: «5/10»</p>
          </div>
          <button
            onClick={nextRound}
            className="px-6 py-3.5 rounded-xl bg-rose-600 hover:bg-rose-500 text-white font-extrabold text-xs transition cursor-pointer shadow-lg shadow-rose-600/20 flex items-center gap-1.5 uppercase tracking-wider"
          >
    ...
    return (
      <div className="flex flex-col gap-6 w-full animate-fadeIn max-w-3xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-zinc-950 p-4 rounded-2xl border border-zinc-800/80 shadow-lg">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <span className="px-3.5 py-1.5 rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 text-slate-950 text-xs font-black font-mono shadow-md shadow-amber-500/20">
          ...
          {[1, 2, 3, 4].map((step) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-xs font-black font-mono">+{pts} б.</span>
              </div>
            );
          })}
        </div>
        ...
        <div className="bg-white text-slate-950 p-6 sm:p-9 rounded-3xl shadow-2xl border-4 border-rose-500 text-center relative overflow-hidden">
          <div className="flex items-center justify-center gap-2 mb-2">
            <span className="px-3 py-0.5 rounded-full bg-rose-600 text-white text-[10px] font-black uppercase tracking-widest">
          ...
          <h3 className="text-lg sm:text-2xl font-black leading-snug uppercase tracking-tight text-slate-950 mt-2">
            "{currentCommentText}"
          </h3>
        </div>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider">
              Варіанти відповідей (клікніть озвучений командою варіант):
            </span>
            <span className="text-[9px] text-zinc-500 font-semibold">
              🟢 — позначка правильної відповіді для ведучого
            </span>
          </div>
            ...
            {shuffledVideoOptions.map((opt, optIdx) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <span className="w-8 h-8 rounded-xl bg-slate-950 text-white flex items-center justify-center font-mono font-black text-sm">
                        {letter}
                      </span>
                      <span className="text-sm sm:text-base font-black uppercase tracking-tight">{opt}</span>
                    </div>
                    {isCorrect && (
                      <span className="text-xs font-black bg-slate-950 text-emerald-400 px-2.5 py-1 rounded-lg border border-emerald-400/40 uppercase">
                        ✓ Справжнє
                      </span>
                    )}
                  </div>
              ...
              if (isEliminated) {
                return (
                  <div
                    key={optIdx}
                    className="p-4 sm:p-5 rounded-2xl border border-zinc-900 bg-zinc-950/40 text-zinc-600 line-through opacity-40 flex items-center justify-between cursor-not-allowed"
                  >
                    <div className="flex items-center gap-3">
                      <span className="w-8 h-8 rounded-xl bg-zinc-900 text-zinc-600 flex items-center justify-center font-mono font-bold text-sm">
                        {letter}
                      </span>
                      <span className="text-sm font-semibold">{opt}</span>
                    </div>
                    <span className="text-[10px] font-bold text-rose-500 uppercase">✗ Невірно</span>
                  </div>
                );
              }
              ...
              return (
                <button
                  ...
                  className="p-4 sm:p-5 rounded-2xl bg-gradient-to-br from-amber-400 via-amber-500 to-orange-500 hover:from-amber-300 hover:via-amber-400 hover:to-orange-400 text-slate-950 border-2 border-amber-300 hover:border-white shadow-xl flex items-center justify-between cursor-pointer hover:scale-[1.02] active:scale-[0.98] transition duration-200"
                >
                  <div className="flex items-center gap-3">
                    <span className="w-8 h-8 rounded-xl bg-slate-950 text-amber-400 flex items-center justify-center font-mono font-black text-sm shadow-inner">
                      {letter}
                    </span>
                    <span className="text-sm sm:text-base font-black leading-tight uppercase tracking-tight text-slate-950 drop-shadow-sm">
                      {opt}
                    </span>
                  </div>
                  ...
                  {isCorrect && (
                    <span
                      className="w-3 h-3 rounded-full bg-emerald-700 border-2 border-emerald-400 flex-shrink-0"
                      title="Правильна відповідь (підказка ведучому)"
                    />
                  )}
                </button>
              );
          ...
          <div className="flex flex-col items-center gap-3 w-full animate-fadeIn mt-2">
            ...
            >
              {commentsPointsEarned! > 0 ? (
                <span>
                  🎉 Вірно! Вгадано з {commentsRevealedCount}-ї спроби (+{commentsPointsEarned} {commentsPointsEarned === 1 ? "бал" : "бали"} для команди {playingTeamName})
                </span>
              ) : (
                <span>
            ...
            <button
              ...
              className="w-full py-4 bg-gradient-to-r from-rose-600 to-pink-600 hover:from-rose-500 hover:to-pink-500 text-white rounded-2xl font-black text-sm uppercase tracking-wider transition cursor-pointer shadow-xl shadow-rose-600/20 flex items-center justify-center gap-2"
            >
              <span>
                {commentsGameIndex + 1 < 4
                  ? `Перейти до наступної гри (Гра ${commentsGameIndex + 2}/4 • Хід команди ${gameSettings[nextPlayingTeam].name})`
  ...
  const renderBlitzRound = (round: Round) => {
    ...
    if (isRoundFinished) {
      return (
        <div className="flex flex-col items-center justify-center gap-6 py-8 animate-fadeIn w-full text-center">
          <div className="w-16 h-16 rounded-2xl bg-amber-500 flex items-center justify-center text-slate-950 shadow-xl shadow-amber-500/20 mb-2 font-black text-2xl">
            🏆
          </div>
          <div>
            <span className="px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-400 text-xs font-bold uppercase tracking-wider">
            ...
            <h2 className="text-3xl font-black text-white mt-3">Усі 8 питань 5/10 зіграно</h2>
          </div>
          <button
            onClick={nextRound}
            className="px-6 py-3 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-extrabold text-xs transition cursor-pointer shadow-lg shadow-amber-500/20 flex items-center gap-1.5 uppercase tracking-wider"
    ...
    return (
      <div className="flex flex-col gap-6 w-full animate-fadeIn max-w-2xl mx-auto">
        ...
        <div className="bg-zinc-950 border border-zinc-800 rounded-3xl p-5 flex flex-col items-center justify-center relative shadow-2xl">
          ...
          <div className="flex items-center gap-3 mt-2">
            {!blitz10TimerActive ? (
              <button
                ...
                className="px-6 py-2.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-extrabold text-xs transition flex items-center gap-2 cursor-pointer shadow-lg shadow-amber-500/20"
              >
              ...
              <button
                ...
                className="px-6 py-2.5 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-white font-extrabold text-xs transition flex items-center gap-2 border border-zinc-700 cursor-pointer"
              >
            ...
            <button
              ...
              className="p-2.5 rounded-xl bg-zinc-900 hover:bg-zinc-800 text-zinc-400 hover:text-white border border-zinc-800 cursor-pointer"
        ...
        {/* Question Card */}
        <div className="bg-zinc-900 border border-zinc-800 p-6 rounded-2xl text-center shadow-lg">
        ...
        <div className="space-y-3">
          ...
          {questionAnswered && (
            <button
              ...
              className="w-full py-3.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl font-extrabold text-xs uppercase tracking-wider transition cursor-pointer flex items-center justify-center gap-1.5 shadow-lg shadow-indigo-600/20"
            >
  ...
  const renderAliasRound = (round: Round) => {
    ...
    if (isAllTurnsFinished) {
      return (
        <div className="flex flex-col items-center justify-center gap-6 py-8 animate-fadeIn w-full text-center">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-purple-500 to-indigo-600 flex items-center justify-center text-white shadow-xl shadow-purple-500/20 mb-2">
            <Trophy size={32} />
          </div>
          <div>
            ...
            <h2 className="text-3xl font-black text-white mt-3">Усі 8 ходів зіграно!</h2>
          </div>
          <button
            onClick={() => {
              setGameState("finished");
            ...
            className="px-8 py-4 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-extrabold text-sm transition cursor-pointer shadow-lg shadow-purple-600/30 uppercase tracking-wider"
          >
    ...
    return (
      <div className="flex flex-col gap-6 w-full animate-fadeIn max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-zinc-950 p-4 rounded-2xl border border-zinc-800/80 shadow-lg">
          <div>
            <div className="flex items-center gap-2">
              <span className="px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/30 text-purple-400 text-xs font-bold uppercase tracking-wider flex items-center gap-1.5">
                <MessageSquareQuote size={13} />
                Раунд 4: Еліас (Паперові картки)
              </span>
              <span className="text-xs font-bold text-zinc-400 font-mono bg-zinc-900 px-2.5 py-0.5 rounded-md border border-zinc-800">
                Хід {turnInfo.turnNumber}/8 (Круг {turnInfo.circle})
              </span>
            </div>
          ...
          <button
            ...
            className="text-xs bg-zinc-900 hover:bg-zinc-800 text-zinc-300 border border-zinc-800 px-3 py-1.5 rounded-lg transition font-semibold flex items-center gap-1.5 cursor-pointer ml-auto"
          >
            <Edit3 size={13} /> Редагувати склад
          </button>
        </div>

        {/* Active Pair Banner */}
        <div className={`p-4 rounded-2xl border transition flex items-center justify-between gap-3 shadow-lg ${turnInfo.activeTeam === "team1" ? "bg-indigo-950/30 border-indigo-500/40" : "bg-rose-950/30 border-rose-500/40"}`}>
          <div className="flex items-center gap-3">
            <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-black text-white ${turnInfo.activeTeam === "team1" ? "bg-indigo-600" : "bg-rose-600"}`}>
              {turnInfo.turnNumber}
            </div>
            <div>
              ...
              <span className="text-xs sm:text-sm font-bold text-white">
                🗣️ Пояснює: <u className="text-indigo-300">{turnInfo.explainer}</u> ➔ 🎯 Відгадує: <u className="text-emerald-300">{turnInfo.guesser}</u>
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-zinc-950 border border-zinc-800 rounded-3xl p-5 flex flex-col items-center justify-center shadow-2xl relative">
          <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest block mb-1">
          ...
          {aliasTimeLeft === 0 && (
            <div className="px-4 py-2 bg-red-950/40 border border-red-500/50 rounded-xl text-red-400 text-xs font-black uppercase tracking-wider animate-bounce mt-1 flex items-center gap-2">
          ...
          <div className="flex items-center gap-3 mt-3">
            {!aliasTimerActive ? (
              <button
                ...
                className="px-6 py-2.5 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-extrabold text-xs transition flex items-center gap-2 cursor-pointer shadow-lg shadow-purple-600/20 uppercase"
              >
                <Play size={14} className="fill-current" />
        ...
        <div className="p-4 bg-zinc-900 border border-zinc-800 rounded-2xl text-center shadow-lg">
          <div className="flex items-center justify-around text-xs font-bold">
            <div>
              <span className="text-[10px] text-zinc-500 uppercase block">Вгадано (+1)</span>
              <span className="text-2xl font-black text-emerald-400">+{aliasGuessedCount}</span>
            </div>
            <div className="h-8 w-px bg-zinc-800"></div>
            <div>
              <span className="text-[10px] text-zinc-500 uppercase block">Штрафів (-1)</span>
              <span className="text-2xl font-black text-rose-400">-{aliasSkippedCount}</span>
            </div>
            <div className="h-8 w-px bg-zinc-800"></div>
            <div>
              <span className="text-[10px] text-zinc-500 uppercase block">Разом за хід</span>
              <span className="text-2xl font-black text-purple-400 font-mono">{currentTurnPoints} б.</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 w-full">
          <button
            ...
            className="h-20 bg-emerald-600 hover:bg-emerald-500 active:scale-[0.98] text-white rounded-2xl font-black text-lg sm:text-xl transition flex items-center justify-center gap-2 cursor-pointer shadow-xl shadow-emerald-600/20 border border-emerald-400/30"
          >
          ...
          <button
            ...
            className="h-20 bg-rose-600 hover:bg-rose-500 active:scale-[0.98] text-white rounded-2xl font-black text-lg sm:text-xl transition flex items-center justify-center gap-2 cursor-pointer shadow-xl shadow-rose-600/20 border border-rose-400/30"
          >
            <XCircle size={24} />
            <span>-1 ПРОПУСК</span>
          </button>
        ...
        <button
          ...
          className="w-full py-4 bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 hover:opacity-95 text-white rounded-2xl font-black text-sm uppercase tracking-wider transition cursor-pointer shadow-xl shadow-indigo-600/20 flex items-center justify-center gap-2"
        >
        ...
        {aliasTurnSummaryModal && (
          <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 animate-fadeIn">
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6 max-w-md w-full text-center shadow-2xl space-y-4">
              ...
              <h3 className="text-xl font-black text-white">{aliasTurnSummaryModal.teamName}</h3>

              <div className="p-4 bg-zinc-950 rounded-2xl border border-zinc-800 flex justify-around">
                <div>
                  <span className="text-[9px] text-zinc-500 uppercase block">Вгадано</span>
                  <span className="text-xl font-black text-emerald-400">+{aliasTurnSummaryModal.guessed}</span>
                </div>
                <div>
                  <span className="text-[9px] text-zinc-500 uppercase block">Штрафів</span>
                  <span className="text-xl font-black text-rose-400">-{aliasTurnSummaryModal.skipped}</span>
                </div>
                <div>
                  <span className="text-[9px] text-zinc-500 uppercase block">Нараховано</span>
                  <span className="text-xl font-black text-purple-400">{aliasTurnSummaryModal.points} б.</span>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full py-3 bg-purple-600 hover:bg-purple-500 text-white font-bold text-xs rounded-xl uppercase tracking-wider transition cursor-pointer"
              >
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-zinc-50 flex flex-col font-sans select-none pb-20">
      {/* Top Header */}
      <header className="border-b border-zinc-900/80 bg-zinc-950/80 backdrop-blur-md px-4 py-3 sticky top-0 z-40">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-amber-500 to-indigo-600 flex items-center justify-center font-black text-slate-950 text-sm shadow-md shadow-amber-500/20">
              ВКВ
            </div>
            <div>
              <h1 className="text-xs sm:text-sm font-black text-white uppercase tracking-wider">Шоу ВКВ 2026</h1>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <div className="flex items-center bg-zinc-900 border border-zinc-800 rounded-xl p-1 gap-1 shadow-inner">
              <button
                ...
                className="px-2.5 py-1 rounded-lg bg-indigo-950/40 border border-indigo-500/30 text-indigo-400 font-bold text-xs flex items-center gap-1.5 cursor-pointer hover:bg-indigo-900/40 transition"
              >
                <span className="truncate max-w-[90px] sm:max-w-[120px]">{gameSettings.team1.name}:</span>
                <span className="text-sm font-black font-mono">{scores.team1}</span>
              </button>
              ...
              <button
                ...
                className="px-2.5 py-1 rounded-lg bg-rose-950/40 border border-rose-500/30 text-rose-400 font-bold text-xs flex items-center gap-1.5 cursor-pointer hover:bg-rose-900/40 transition"
              >
            ...
            <button
              onClick={() => setEditingSettingsModal(true)}
              className="p-2 bg-zinc-900 hover:bg-zinc-800 text-zinc-400 hover:text-white rounded-lg border border-zinc-800 transition cursor-pointer"
            ...
            <button
              ...
              className="text-xs bg-zinc-900 hover:bg-zinc-800 text-zinc-300 border border-zinc-800 px-2.5 py-1.5 rounded-lg transition font-semibold cursor-pointer"
            >
              Адмінка
            </button>
          </div>
      ...
      {editingSettingsModal && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 animate-fadeIn">
          <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6 max-w-xl w-full shadow-2xl space-y-5 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between pb-3 border-b border-zinc-800">
              <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="text-xs text-zinc-500 hover:text-white p-1 rounded-lg"
              >
                ✕
              </button>
            </div>
              ...
              <div className="p-4 bg-indigo-950/20 border border-indigo-500/30 rounded-2xl space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      ...
                      className="w-6 h-6 bg-zinc-900 border border-zinc-800 rounded text-xs text-zinc-400 flex items-center justify-center"
                    >
                      -1
                    </button>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-zinc-900 border border-indigo-500/30 rounded-xl px-3 py-1.5 text-xs text-white font-bold"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-zinc-900 border border-zinc-800 rounded-lg px-2.5 py-1 text-xs text-zinc-200"
                  />
                  <input
                    type="text"
              ...
              <div className="p-4 bg-rose-950/20 border border-rose-500/30 rounded-2xl space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-zinc-900 border border-rose-500/30 rounded-xl px-3 py-1.5 text-xs text-white font-bold"
                  />
                </div>
            ...
            <div className="flex items-center justify-between pt-2 border-t border-zinc-800">
              ...
              <button
                onClick={() => setEditingSettingsModal(false)}
                className="px-6 py-2.5 bg-gradient-to-r from-amber-500 to-orange-500 text-slate-950 font-black rounded-xl text-xs uppercase tracking-wider transition cursor-pointer shadow-lg shadow-amber-500/20"
              >
      ...
      {/* Main Container */}
      <main className="flex-grow max-w-4xl w-full mx-auto px-4 py-6 flex flex-col justify-center">
        {gameState === "select_game" && (
          <div className="flex flex-col gap-6 py-6 animate-fadeIn">
              ...
              {loading ? (
                ...
                <div className="p-4 bg-zinc-950 border border-dashed border-zinc-800 rounded-2xl text-center space-y-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-indigo-600 text-white rounded-xl text-xs font-bold uppercase"
                  >
                    Перейти в адмінку
                  </button>
                </div>
            ...
            <div className="bg-zinc-900 border border-zinc-800 p-5 rounded-3xl space-y-4 shadow-xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {/* Team 1 Card */}
                <div className="p-4 bg-zinc-950 border border-indigo-500/30 rounded-2xl space-y-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-zinc-900 border border-zinc-800 rounded-xl px-3 py-2 text-xs text-white font-bold focus:outline-none focus:border-indigo-500"
                    />
                  </div>
                ...
                {/* Team 2 Card */}
                <div className="p-4 bg-zinc-950 border border-rose-500/30 rounded-2xl space-y-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-zinc-900 border border-zinc-800 rounded-xl px-3 py-2 text-xs text-white font-bold focus:outline-none focus:border-rose-500"
                    />
                  </div>
                  <div className="space-y-1.5">
                    <label className="text-[9px] font-bold text-zinc-500 uppercase block">Гравці команди</label>
            ...
            <button
              onClick={startGame}
              className="w-full py-4 bg-gradient-to-r from-amber-500 via-orange-500 to-amber-500 hover:from-amber-400 hover:to-orange-400 text-slate-950 rounded-2xl font-black text-sm uppercase tracking-wider transition cursor-pointer shadow-xl shadow-amber-500/20 flex items-center justify-center gap-2"
            >
              <Sparkles size={18} />
        ...
        {gameState === "playing" && (
          <div className="flex flex-col gap-6 w-full animate-fadeIn">
            {/* Round Switcher Tabs */}
            <div className="flex items-center justify-between gap-2 bg-zinc-950 p-1.5 rounded-2xl border border-zinc-800">
                ...
                {rounds.map((r, idx) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-xl text-xs font-black uppercase tracking-wider transition cursor-pointer whitespace-nowrap ${isActive ? "bg-amber-500 text-slate-950 shadow-md shadow-amber-500/30" : "text-zinc-500 hover:text-zinc-300"
                        }`}
                    >
                      {roundLabel}
                    </button>
              ...
              <div className="flex items-center gap-1 flex-shrink-0">
                <button
                  ...
                  onClick={prevRound}
                  className="p-1.5 bg-zinc-900 hover:bg-zinc-800 disabled:opacity-30 rounded-lg text-zinc-400 hover:text-white transition cursor-pointer"
            ...
            {rounds.length === 0 ? (
              <div className="p-8 sm:p-10 bg-zinc-900 border border-zinc-800 rounded-3xl text-center space-y-4 shadow-xl">
                ...
                <div>
                  <h3 className="text-base font-black text-white">У цій грі ще немає збережених раундів</h3>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                  <button
                    ...
                    className="w-full sm:w-auto px-5 py-3 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-slate-950 font-black rounded-xl text-xs uppercase tracking-wider transition cursor-pointer shadow-lg shadow-amber-500/20 flex items-center justify-center gap-2"
                  >
                    {roundsLoading ? (
                      <>
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto px-5 py-3 bg-zinc-800 hover:bg-zinc-700 text-white rounded-xl text-xs font-bold uppercase transition cursor-pointer"
                  >
                    Відкрити адмінку
                  </button>
                </div>
        ...
        {gameState === "finished" && (
          <div className="flex flex-col items-center justify-center gap-6 py-12 animate-fadeIn text-center">
            <div className="w-24 h-24 rounded-3xl bg-gradient-to-tr from-amber-400 via-amber-500 to-indigo-600 flex items-center justify-center text-slate-950 shadow-2xl shadow-amber-500/20 text-4xl mb-2 font-black">
              🏆
            </div>
            ...
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-black text-white mt-3 uppercase tracking-wide">
              ...
              <p className="text-sm text-zinc-400 mt-2 font-mono text-xl font-bold">
            ...
            <div className="flex items-center gap-3 mt-4">
              <button
                ...
                className="px-6 py-3 bg-zinc-900 hover:bg-zinc-800 text-white rounded-xl text-xs font-bold uppercase border border-zinc-800 transition cursor-pointer"
              >
                Пройти гру ще раз
              </button>
              <button
                ...
                className="px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-xs font-bold uppercase transition cursor-pointer shadow-lg shadow-indigo-600/20"
              >
